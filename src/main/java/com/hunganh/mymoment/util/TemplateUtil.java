package com.hunganh.mymoment.util;

import com.hunganh.mymoment.constant.ConfigConstant;
import com.hunganh.mymoment.constant.StringPool;
import com.hunganh.mymoment.dto.AssocOutput;
...
import static com.hunganh.mymoment.util.ConfigUtil.getTemplate;
...
public class TemplateUtil {
    public static String getResultByMap(Map<String, Object> map) {
        ...
        try {
            ...
            config.setDirectoryForTemplateLoading(new File(ConfigConstant.TEMPLATE_CONFIG_DIRECTORY));
            for (Map.Entry<String, Object> entry : map.entrySet()) {
                System.out.println(entry.getKey() + ":" + entry.getValue());
                Template template = config.getTemplate(getTemplate(entry.getKey()));
